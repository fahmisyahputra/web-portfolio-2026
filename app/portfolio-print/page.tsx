...
export default function PrintablePortfolio() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-8 print:p-0 print:bg-white flex justify-center items-start">
            {/* A4 Container */}
            <main className="w-[210mm] min-h-[297mm] bg-white shadow-2xlprint:shadow-none print:w-full print:m-0 p-[15mm] text-gray-900 font-sans leading-relaxed relative mx-auto my-0">
